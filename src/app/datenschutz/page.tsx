  ...
  return (
    ...
    <div className="mb-6 leading-7">
        ...
        <p>
          ...
          <br />
          Zur Verwaltung von Benutzerkonten nutzen wir den Dienst „Clerk“. Dabei
          werden Daten wie Name, E-Mail, Anmeldeverlauf und ggf. Profilbild
          verarbeitet.
          <br />
          Anbieter: Clerk Inc., 548 Market St, San Francisco, CA 94104, USA.
          <br />
          Die Datenverarbeitung erfolgt auf Basis von Art. 6 Abs. 1 lit. b DSGVO
          (zur Vertragserfüllung) und ggf. Art. 6 Abs. 1 lit. a DSGVO
          (Einwilligung).
        </p>
        ...
        <p>
          ...
          <br />
          Diese Datenschutzerklärung wurde zuletzt im Mai 2025 aktualisiert und
          kann sich künftig ändern.
        </p>
        </div>
      </div>
    </main>
